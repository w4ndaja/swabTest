                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control @error('username') border-danger @enderror" name="username" value="{{old('username')}}" id="inputUsername">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="password" class="form-control @error('password') border-danger @enderror" name="password" value="{{old('password')}}" id="inputPassword">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="password" class="form-control @error('password_confirmation') border-danger @enderror" name="password_confirmation" value="{{old('password_confirmation')}}" id="inputPasswordConfirmation">
